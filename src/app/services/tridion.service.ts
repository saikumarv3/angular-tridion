...
export class TridionService {
  ...
  private contentSubject = new BehaviorSubject<TridionContent>(this.content);

  getContent(): Observable<TridionContent> {
    return this.contentSubject.asObservable();
  }

  // In a real application, this would fetch from Tridion
  loadContent(): void {
    // Simulating API call to Tridion
    // this.http.get<TridionContent>('your-tridion-endpoint').subscribe(
    //   content => this.contentSubject.next(content)
    // );
  }
} 